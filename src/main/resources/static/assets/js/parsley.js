            ...
            , type: function (val, type) {
                ...
                switch (type) {
                    ...
                    case 'NIF':
                        ...
                        break;
                    case 'name':
                        regExp = /^([A-Za-záéíóúñ\s]{2,})+$/;
                        break;
                    case 'namecomplete':
                        regExp = /^[A-Za-záéíóúñ]{2,}([\s][A-Za-záéíóúñ\s]{2,})+$/;
                        break;
                    case 'alphanum':
                        regExp = /^([0-9A-Za-záéíóúñÁÉÍÓÚÑ!?¿¡":\.\s-_(, )(,)( )(; )(;)( )]{2,})+$/;
                        break;
                    case 'email':
                    ...
                    case 'dateIso':
                        ...
                        break;
                    case 'datePer':
                        regExp = /^([12]\d|0[1-9]|3[01])\D?(0[1-9]|1[0-2])\D?(\d{4})$/;
                        break;
                    case 'phone':
                        regExp = /^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$/;
                        break;
                    case 'address':
                        regExp = /^.*(?=.*[0-9])(?=.*[a-zA-ZñÑ\s+]).*$/;
                        break;
                    case 'code':
                        regExp = /^.*(?=.*[0-9])(?=.*[a-zA-ZñÑ\s+]).*$/;
                        break;
